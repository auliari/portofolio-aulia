                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                            ...
                            <td>
                                <a href='edit_barang.php?barang_id=" . $row['barang_id'] . "' class='btn btn-warning btn-sm'><i class='fas fa-cog'></i></a>
                                <a href='hapus_barang.php?barang_id=" . $row['barang_id'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Yakin ingin menghapus?\");'><i class='fas fa-trash'></i></a>
                            </td>
                        </tr>";
                    }
                } else {
