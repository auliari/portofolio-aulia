            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item d-flex align-items-center mr-3">
                    ...
                    <span class="text-white font-weight-bold">
                        <?php echo $user['user_nama']; ?> - administrator
                    </span>
                </li>
                <li class="nav-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" href="#menuPengguna" role="button" aria-expanded="false" aria-controls="menuPengguna">
                            ...
                            <ul class="nav flex-column collapse" id="menuPengguna">
                                <li class="nav-item">
                                    <a href="daftar_pengguna.php" class="nav-link">
                        ...
                        <li class="nav-item"><a href="ganti_password.php" class="nav-link"><i class="fas fa-key"></i> Ganti Password</a></li>
