...
<?php
    ...
    ?>
    <div class="container">
        <center><h2 style="color:#921A40;">LAPORAN LAUNDRY</h2></center>
        <br><br>
        <?php
        ...
        <table class="table table-bordered table-striped">
                ...
                <?php
                    ...
                    transaksi.pelanggan_id and date(transaksi_tgl) > '$dari' and date(transaksi_tgl) < '$sampai' order by transaksi_id desc limit 7");
                    $no = 1;
