...
<div class="container">
    <div class="panel">
        <div class="panel-heading"><h4 style="color:#921A40;">Edit Transaksi Laundry</h4></div>
        <div class="panel-body">
            ...
            <form action="transaksi_update.php" method="POST">
                ...
                <div class="form-group">
                    <label style="color:#921A40;">Pelanggan</label>
                ...
                <div class="form-group">
                    <label style="color:#921A40;">Berat</label>
                    <input type="number" name="berat" class="form-control" placeholder="Masukan berat cucian" required="required" value="<?php echo $t['transaksi_berat'] ?>">
                </div>

                <div class="form-group">
                    <label style="color:#921A40;">Tanggal Selesai</label>
                    <input type="date" name="tgl_selesai" class="form-control" required="required" value="<?php echo $t['transaksi_tgl_selesai'] ?>">
                </div>
                ...
                <tr style="background-color: rgba(255, 51, 51, 0.05); color: #921A40;">
                    ...
                    <div class="form-group alert alert-info">
                        <label style="color:#921A40;">Status</label>
