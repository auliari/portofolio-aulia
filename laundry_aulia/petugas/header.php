...
<body style="background: #EBF4F6">
    <?php
        ...
        if($_SESSION['status']!="login"){
            header("location:../index2.php?pesan=belum_login");
        }
    ?>
    ...
    <nav style="background-color:rgb(255, 255, 255);" style="border-radius:0px">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index2.php" style="color:#921A40;">Laundry</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="index2.php" style="color:#921A40;"><i class="glyphicon glyphicon-home"></i> Dashboard</a></li>
