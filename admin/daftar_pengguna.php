                ...
                <tbody>
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                <a href='edit_pengguna.php?id=<?= $row['user_id'] ?>' class='btn btn-warning btn-sm'><i class='fas fa-cog'></i></a>
                                <a href='hapus_pengguna.php?id=<?= $row['user_id'] ?>' class='btn btn-danger btn-sm' onclick='return confirm("Yakin ingin menghapus?");'><i class='fas fa-trash'></i></a>
                            </td>
                        </tr>
                        <?php
                                $no++;
